...
export default function App(){return <QueryClientProvider client={queryClient}><ThemeProvider><AuthProvider><OperationsProvider><OfflineBanner/><MaintenanceGate><AppRouter/></MaintenanceGate><PwaInstallPrompt/><CookieNotice/><Toaster position="top-right" toastOptions={{duration:4000,style:{background:'#2D2D2D',color:'#FFFFFF',borderRadius:'14px'}}}/></OperationsProvider></AuthProvider></ThemeProvider></QueryClientProvider>}
